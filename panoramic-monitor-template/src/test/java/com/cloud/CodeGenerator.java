...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/risk";
    ...
    private static final String BASE_PACKAGE_PATH = "/com/risk/warning";//项目基础包路径
    ...
    public static void main(String[] args) {
        genCode("panoramic_email_send_info");	
    }
